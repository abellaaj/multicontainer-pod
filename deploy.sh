...
#server
oc import-image multicontainer-server:0.0.1-SNAPSHOT --from=picnex000.dom101.mapres:8084/bpcesa/siq/multicontainer-server:0.0.1-SNAPSHOT --confirm --insecure=true
...
#client
oc import-image multicontainer-client:0.0.1-SNAPSHOT --from=picnex000.dom101.mapres:8084/bpcesa/siq/multicontainer-client:0.0.1-SNAPSHOT --confirm --insecure=true
